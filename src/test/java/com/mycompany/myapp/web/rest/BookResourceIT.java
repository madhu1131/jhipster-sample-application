...
class BookResourceIT {
    ...
    public static Book createEntity(EntityManager em) {
        Book book = new Book().title(DEFAULT_TITLE).publishDate(DEFAULT_PUBLISH_DATE).cost(DEFAULT_COST).description(DEFAULT_DESCRIPTION);
        return book;
    }
    ...
    public static Book createUpdatedEntity(EntityManager em) {
        Book book = new Book().title(UPDATED_TITLE).publishDate(UPDATED_PUBLISH_DATE).cost(UPDATED_COST).description(UPDATED_DESCRIPTION);
        return book;
    }
    ...
    void putNewBook() throws Exception {
        ...
        updatedBook.title(UPDATED_TITLE).publishDate(UPDATED_PUBLISH_DATE).cost(UPDATED_COST).description(UPDATED_DESCRIPTION);
    ...
    void partialUpdateBookWithPatch() throws Exception {
        ...
        partialUpdatedBook.title(UPDATED_TITLE).cost(UPDATED_COST);
    ...
    void fullUpdateBookWithPatch() throws Exception {
        ...
        partialUpdatedBook.title(UPDATED_TITLE).publishDate(UPDATED_PUBLISH_DATE).cost(UPDATED_COST).description(UPDATED_DESCRIPTION);
